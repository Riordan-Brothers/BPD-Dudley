...
namespace UserModule_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V8
{
    public class UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V8 : SplusObject
    {
...
public override void LogosSplusInitialize()
{
    ...
    LEVEL_IN = new InOutArray<AnalogInput>( 4, this );
    for( uint i = 0; i < 4; i++ )
    {
    ...
    LEVEL_OUT = new InOutArray<AnalogOutput>( 4, this );
    for( uint i = 0; i < 4; i++ )
    {
...
public UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V8 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
